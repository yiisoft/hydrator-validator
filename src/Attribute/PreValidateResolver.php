...
final class PreValidateResolver implements ParameterAttributeResolverInterface
{
    ...
    {
        if (!$attribute instanceof PreValidate) {
            throw new UnexpectedAttributeException(PreValidate::class, $attribute);
        }
